...
def profile_update(request):
    ...
    if request.method == 'POST':
        ...
        if update.is_valid():
            user = update.save()
            new = user.first_name
            messages.success(request, f'Congratulations {{new}}, Your Profile Is Successfully Updated!.....')
...
def deleteitem(request):
    if request.method == 'POST':
        ...
        item_delete.delete()
        messages.success(request, 'Cart sucessfully deleted!...')
...
def history(request):
    ...
    # query_set = Models.objects(manager).method of query
